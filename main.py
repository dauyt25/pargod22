...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # 🚫 מילים אסורות
    FORBIDDEN_WORDS = ["להטב", "האח הגדול", "גיי", "עבירות", "קטינה", "גבר", "אירוויזיון",
        "קטינות", "בקטינה", "מינית", "חיים רוטר", "מיניות", "באח הגדול", "באונס",
        "בגבר", "אליפות", "רוכב", "כדורגל", "כדורסל", "ספורט", "ליגה", "אולימפיאדה",
        ...
        "להט\"ב", "להטב״ים", "להטביים", "שחקנית", "עבירות", "קטינה", "גבר",
